let data = {
  ...
  menu: [
    ...
    { type: "總匯拼盤", title: "家鄉通訊錄佐手做 API (1)", link: "javascript:;" },
    { type: "總匯拼盤", title: "家鄉通訊錄佐手做 API (2)", link: "javascript:;" },
    { type: "用餐插曲", title: "怎麼沒有滷肉飯? 其他菜色瀏覽", link: "javascript:;" },
    { type: "餐具擺盤", title: "特製雕花 Vue-CLI 3.0", link: "javascript:;" },
    ...
    { type: "主廚推薦", title: "共享式集中數據管理大雜燴", link: "javascript:;" },
    ...
    { type: "總匯拼盤", title: "復古總匯 TodoList 燴頁面模組", link: "javascript:;" },
    { type: "總匯拼盤", title: "復古總匯 TodoList 燴頁面模組", link: "javascript:;" },
    { type: "總匯拼盤", title: "復古總匯 TodoList 燴頁面模組", link: "javascript:;" },
